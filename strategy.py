...
class Strategy:
    def __init__(self, client: "BinanceFuturesClient", contract, exchange: str,
                 timeframe: str, balance_pct: float, take_profit: float,
    ...
    def _open_position(self, signal_result: int):
        ...
        if order_status is not None:
            ...
            new_trade = ({"time": int(time.time() * 1000), "entry_price": avg_fill_price,
